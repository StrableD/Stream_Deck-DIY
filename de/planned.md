...
5. Erstellen und Ausprobieren der Taster (Plexiglas zuschneiden, 3D-Druck der Halterungen, etc.)
...
_Anmerkungen_: Sowohl das Erstellen des Taster-Designs als auch die Softwareentwicklung könnten parallel laufen, da sie sich nicht direkt beeinflussen.
Jedoch kann das wirkliche Testen von beidem erst erfolgen, wenn die Hardware (PCB, Taster) verfügbar ist.
...
- Komplexität der Taster: Das Design und die Herstellung der Taster könnte komplexer sein als erwartet, insbesondere wenn es um die Integration von Plexiglas, 3D-gedruckten Teilen und der Diode geht.
